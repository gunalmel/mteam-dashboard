...
export const explanationItems = [
    ...
    { icon: '🫀', url: '/icons/shock.png', text: 'Order Pericardiocentesis', relatedMarkers: ["Order Pericardiocentesis","heartneedle_pericard_anytime"], yValue: 5.5 },
    { icon: '🔬', url: '/icons/shock.png', text: 'Order Ultrasound', relatedMarkers: ["Order Ultrasound","ultrasound_FAST_anytime"], yValue: 6 },
    ...
    { icon: '💉', url: '/icons/medication.png', text: 'Select Epinephrine', relatedMarkers: ["Select Epinephrine","Epi","Amio_or_Lidocaine","glucose_anytime","lunglisten_anytime","chestneedle_thora_anytime","ROSC_Fentanyl_or_Propofol"], yValue: 2.5 },
    { icon: '⚡', url: '/icons/shock.png', text: 'SYNCHRONIZED Shock 100J', relatedMarkers: ["SYNCHRONIZED Shock 100J","defib<149_sync_or_unsync"], yValue: 1.6 },
    { icon: '⚡', url: '/icons/shock.png', text: 'SYNCHRONIZED Shock 175J', relatedMarkers: ["SYNCHRONIZED Shock 175J"], yValue: 1.5 },
    { icon: '⚡', url: '/icons/shock.png', text: 'SYNCHRONIZED Shock 200J', relatedMarkers: ["SYNCHRONIZED Shock 200J","sync_defib_150+"], yValue: 1.7 },
    { icon: '⚡', url: '/icons/shock.png', text: 'Defib (UNsynchronized Shock) 200J', relatedMarkers: ["Defib (UNsynchronized Shock) 200J","unsync_defib_150+"], yValue: 2 },
