...
export const explanationItems = [
    ...
    { icon: '⚡', url: '/icons/synchronized-shock.png', text: 'SYNCHRONIZED Shock 100J', relatedMarkers: ["SYNCHRONIZED Shock 100J","defib<149_sync_or_unsync"], yValue: 1.6 },
    { icon: '⚡', url: '/icons/synchronized-shock.png', text: 'SYNCHRONIZED Shock 175J', relatedMarkers: ["SYNCHRONIZED Shock 175J"], yValue: 1.5 },
    { icon: '⚡', url: '/icons/synchronized-shock.png', text: 'SYNCHRONIZED Shock 200J', relatedMarkers: ["SYNCHRONIZED Shock 200J","sync_defib_150+"], yValue: 1.7 },
    { icon: '⚡', url: '/icons/unsynchronized-shock.png', text: 'Defib (UNsynchronized Shock) 200J', relatedMarkers: ["Defib (UNsynchronized Shock) 200J","unsync_defib_150+"], yValue: 2 },
