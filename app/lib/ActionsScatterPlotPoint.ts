...
import {actionsDictionary, getIcon} from '@/app/ui/components/constants';
...
export default class ActionsScatterPlotPoint {
    ...
    #createImage(){
        return new PlotlyScatterImage(this.icon.url, this.x.dateTimeString, this.y).toPlotlyFormat();
    }
}
